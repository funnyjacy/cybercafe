/********************************************************************************
** Form generated from reading UI file 'on.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *on)
    {
        if (on->objectName().isEmpty())
            on->setObjectName(QString::fromUtf8("on"));
        on->resize(431, 374);
        centralwidget = new QWidget(on);
        ...
        on->setCentralWidget(centralwidget);

        retranslateUi(on);

        QMetaObject::connectSlotsByName(on);
    } // setupUi

    void retranslateUi(QMainWindow *on)
    {
        on->setWindowTitle(QCoreApplication::translate("on", "on", nullptr));
        label->setText(QCoreApplication::translate("on", "\344\270\212\346\234\272\345\225\246", nullptr));
        OK->setText(QCoreApplication::translate("on", "\344\270\212\346\234\272", nullptr));
        NO->setText(QCoreApplication::translate("on", "\345\217\226\346\266\210", nullptr));
        label_2->setText(QCoreApplication::translate("on", "\345\215\241\345\217\267", nullptr));
        label_3->setText(QCoreApplication::translate("on", "\345\257\206\347\240\201", nullptr));
    } // retranslateUi

};

namespace Ui {
    class on: public Ui_on {};
} // namespace Ui
